...
export function registerEquipmentHubTools(server) {
    // Tool A: Alle Hierarchien (raw) abrufen
    server.registerTool("ec_hierarchies_list", {
        title: "EquipmentCloud: Hierarchien (EquipmentHub) abrufen",
        description: "Liest alle Hierarchien aus /equipmenthub/v1/hierarchies. Achtung: Kann viele Einträge liefern.",
    ...
    server.registerTool("ec_hierarchy_resolve", {
        title: "EquipmentCloud: Hierarchie-Namen auflösen",
        description: "Sucht in /equipmenthub/v1/hierarchies nach Namen und gibt passende IDs zurück. Unterstützt exakte und partielle Matches.",
        inputSchema: {
